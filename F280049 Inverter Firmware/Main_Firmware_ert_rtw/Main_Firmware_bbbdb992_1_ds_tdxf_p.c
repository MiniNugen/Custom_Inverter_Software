...
int32_T Main_Firmware_bbbdb992_1_ds_tdxf_p(const NeDynamicSystem *LC, const
  NeDynamicSystemInput *t1, NeDsMethodOutput *out)
{
  static int32_T _cg_const_2[65] = { 0, 12, 3, 4, 14, 15, 16, 2, 3, 4, 5, 12, 4,
    13, 14, 15, 16, 3, 13, 14, 15, 16, 6, 7, 8, 9, 10, 11, 3, 4, 6, 7, 14, 6, 7,
    3, 4, 6, 8, 14, 15, 3, 4, 6, 10, 14, 16, 3, 4, 8, 9, 15, 8, 9, 3, 4, 10, 11,
    16, 10, 11, 1, 5, 5, 13 };

  static int32_T _cg_const_1[18] = { 0, 2, 2, 7, 12, 17, 22, 28, 33, 35, 41, 47,
    52, 54, 59, 61, 63, 65 };
  ...
  out->mTDXF_P.mIr[39] = _cg_const_2[39];
  out->mTDXF_P.mIr[40] = _cg_const_2[40];
  out->mTDXF_P.mIr[41] = _cg_const_2[41];
  out->mTDXF_P.mIr[42] = _cg_const_2[42];
  out->mTDXF_P.mIr[43] = _cg_const_2[43];
  out->mTDXF_P.mIr[44] = _cg_const_2[44];
  out->mTDXF_P.mIr[45] = _cg_const_2[45];
  out->mTDXF_P.mIr[46] = _cg_const_2[46];
  out->mTDXF_P.mIr[47] = _cg_const_2[47];
  out->mTDXF_P.mIr[48] = _cg_const_2[48];
  out->mTDXF_P.mIr[49] = _cg_const_2[49];
  out->mTDXF_P.mIr[50] = _cg_const_2[50];
  out->mTDXF_P.mIr[51] = _cg_const_2[51];
  out->mTDXF_P.mIr[52] = _cg_const_2[52];
  out->mTDXF_P.mIr[53] = _cg_const_2[53];
  out->mTDXF_P.mIr[54] = _cg_const_2[54];
  out->mTDXF_P.mIr[55] = _cg_const_2[55];
  out->mTDXF_P.mIr[56] = _cg_const_2[56];
  out->mTDXF_P.mIr[57] = _cg_const_2[57];
  out->mTDXF_P.mIr[58] = _cg_const_2[58];
  out->mTDXF_P.mIr[59] = _cg_const_2[59];
  out->mTDXF_P.mIr[60] = _cg_const_2[60];
  out->mTDXF_P.mIr[61] = _cg_const_2[61];
  out->mTDXF_P.mIr[62] = _cg_const_2[62];
  out->mTDXF_P.mIr[63] = _cg_const_2[63];
  out->mTDXF_P.mIr[64] = _cg_const_2[64];
  (void)LC;
  (void)out;
  return 0;
}
